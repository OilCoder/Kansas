...
# ----------------------------------------------------------------------------------
OPTIM_N_TRIALS = 20       # Number of optimization trials
OPTIM_TOP_N = 3           # Number of top configurations to select
OPTIM_N_JOBS = 10        # Number of parallel jobs for optimization
...
# Possible sizes for each hidden layer (if using the same size for all layers)
...
OPTIM_BATCH_SIZE_OPTIONS = [16, 32, 64, 128, 256, 512]
