"""Visualizes neural network prediction results from CSV files. Supports task-specific directory detection, comparative plotting across wells, individual well analysis, and automatic data loading for comprehensive prediction evaluation."""
